...
export function groupGamesByCategory(games: any[]) {
  ...
  const categoriesOrder = [
    "67f036eb22358178b7bb5415", "67f03c4822358178b7bb54ac", "67f042c022358178b7bb5509", "67f0424c22358178b7bb54fc",
    "67f0428d22358178b7bb5503", "67f0419a22358178b7bb54e5", "67f0439822358178b7bb5513", "67f0383a22358178b7bb5435",
    "67f039b122358178b7bb545d", "67f0395622358178b7bb544d", "67f03a0e22358178b7bb546a",
    "67f040db22358178b7bb54dc", "67f03f9022358178b7bb54c0", "67f03f0c22358178b7bb54b8",
    "67f0372722358178b7bb5419", "67f03f6822358178b7bb54bc", "685746901d02db3045791285",
    "67f03bdb22358178b7bb549b", "685745b41d02db3045791276", "67f03b5f22358178b7bb5490",
    "67f03b9e22358178b7bb5496", "67f0398d22358178b7bb5455", "685744c11d02db3045791254",
    "685747561d02db30457912a5", "67f037f322358178b7bb5431", "685749171d02db30457912d8",
  ...
  const beforeId = "67f044b222358178b7bb5521"
  ...
  // --- Build a dynamic categories order ---
  const dynamicOrder = [...categoriesOrder]

  // Find insertion point
  const beforeIdx = categoriesOrder.indexOf(beforeId)
  const insertIdx = beforeIdx !== -1 ? beforeIdx + 1 : categoriesOrder.length

  // Insert unknown category IDs into order
  groupedValues.forEach((cat) => {
    if (!dynamicOrder.includes(cat.id)) {
      dynamicOrder.splice(insertIdx, 0, cat.id)
    }
  })

  // --- Sort by dynamic order ---
  groupedValues.sort((a, b) => {
    return dynamicOrder.indexOf(a.id) - dynamicOrder.indexOf(b.id)
  })
