...
export async function generateMetadata() {
  const page = TotalsportekMetadata.categories["soccer" as keyof typeof TotalsportekMetadata.categories]

  if (!page) return {}

  let blog = [];
  const blogData = await getBlogByCategorySlug("soccer");
  ...
  return {
    ...
    openGraph: {
      title: page.title,
      description: page.description,
      url: `https://totalsportek.world/streams/1/soccer`,
    },
    other: {
      'article:published_time': publishedTime,
    },
    alternates: {
      canonical: `https://totalsportek.world/streams/1/soccer`,
    },
  }
}
